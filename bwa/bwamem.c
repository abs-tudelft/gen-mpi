...
static void str_len2count(int beginPos, char *refID, char *s)
{
if (strcmp(refID, "chr1")==0)  
{
if (beginPos < 24895642 )  
{sam_length[0]+=strlen(s);}
else if (beginPos >= 24895642 && beginPos < 49791284)
{sam_length[1]+=strlen(s);}
else if (beginPos >= 49791284 && beginPos < 74686926) 
{sam_length[2]+=strlen(s);}
 else if (beginPos >= 74686926 && beginPos < 99582568)
 {sam_length[3]+=strlen(s);}
 else if (beginPos >= 99582568 && beginPos < 124478210)
 {sam_length[4]+=strlen(s);}
 else if (beginPos >= 124478210 && beginPos < 149373852)
 {sam_length[5]+=strlen(s);}
 else if (beginPos >= 149373852 && beginPos < 174269494)
 {sam_length[6]+=strlen(s);}
 else if (beginPos >= 174269494 && beginPos < 199165136)
 {sam_length[7]+=strlen(s);}
 else if (beginPos >= 199165136 && beginPos < 224060778)
 {sam_length[8]+=strlen(s);}
 else {sam_length[9]+=strlen(s);}
}
else if (strcmp(refID, "chr2")==0)
{
if (beginPos < 24219352 )  
 {sam_length[10]+=strlen(s);}
 else if (beginPos >= 24219352 && beginPos < 48438704) 
 {sam_length[11]+=strlen(s);}
 else if (beginPos >= 48438704 && beginPos < 72658056) 
 {sam_length[12]+=strlen(s);}
 else if (beginPos >= 72658056 && beginPos < 96877408)
 {sam_length[13]+=strlen(s);}
 else if (beginPos >= 96877408 && beginPos < 121096760)
 {sam_length[14]+=strlen(s);}
 else if (beginPos >= 121096760 && beginPos < 145316112)
 {sam_length[15]+=strlen(s);}
 else if (beginPos >= 145316112 && beginPos < 169535464)
 {sam_length[16]+=strlen(s);}
 else if (beginPos >= 169535464 && beginPos < 193754816)
 {sam_length[17]+=strlen(s);}
 else if (beginPos >= 193754816 && beginPos < 217974168)
 {sam_length[18]+=strlen(s);}
 else {sam_length[19]+=strlen(s);}
}
else if (strcmp(refID, "chr3")==0) 
{
if (beginPos < 24786944 )  
 {sam_length[20]+=strlen(s);}
 else if (beginPos >= 24786944 && beginPos < 49573888) 
 {sam_length[21]+=strlen(s);}
 else if (beginPos >= 49573888 && beginPos < 74360832) 
 {sam_length[22]+=strlen(s);}
 else if (beginPos >= 74360832 && beginPos < 99147776) 
 {sam_length[23]+=strlen(s);}
 else if (beginPos >= 99147776 && beginPos < 123934720) 
 {sam_length[24]+=strlen(s);}
 else if (beginPos >= 123934720 && beginPos < 148721664) 
 {sam_length[25]+=strlen(s);}
 else if (beginPos >= 148721664 && beginPos < 173508608) 
 {sam_length[26]+=strlen(s);}
 else {sam_length[27]+=strlen(s);}
}
else if (strcmp(refID, "chr4")==0) 
{
if (beginPos < 23776819 )  
 {sam_length[28]+=strlen(s);}
 else if (beginPos >= 23776819 && beginPos < 47553638) 
 {sam_length[29]+=strlen(s);}
 else if (beginPos >= 47553638 && beginPos < 71330457) 
 {sam_length[30]+=strlen(s);}
 else if (beginPos >= 71330457 && beginPos < 95107276) 
 {sam_length[31]+=strlen(s);}
 else if (beginPos >= 95107276 && beginPos < 118884095) 
 {sam_length[32]+=strlen(s);}
 else if (beginPos >= 118884095 && beginPos < 142660914) 
 {sam_length[33]+=strlen(s);}
 else if (beginPos >= 142660914 && beginPos < 166437733) 
 {sam_length[34]+=strlen(s);}
 else {sam_length[35]+=strlen(s);}
}
else if (strcmp(refID, "chr5")==0) 
{
if (beginPos < 22692282 )  
 {sam_length[36]+=strlen(s);}
 else if (beginPos >= 22692282 && beginPos < 45384564) 
 {sam_length[37]+=strlen(s);}
 else if (beginPos >= 45384564 && beginPos < 68076846) 
 {sam_length[38]+=strlen(s);}
 else if (beginPos >= 68076846 && beginPos < 90769128) 
 {sam_length[39]+=strlen(s);}
 else if (beginPos >= 90769128 && beginPos < 113461410) 
 {sam_length[40]+=strlen(s);}
 else if (beginPos >= 113461410 && beginPos < 136153692) 
 {sam_length[41]+=strlen(s);}
 else if (beginPos >= 136153692 && beginPos < 158845974) 
 {sam_length[42]+=strlen(s);}
 else {sam_length[43]+=strlen(s);}
}
else if (strcmp(refID, "chr6")==0) 
{
if (beginPos < 24400854 )  
 {sam_length[44]+=strlen(s);}
 else if (beginPos >= 24400854 && beginPos < 48801708) 
 {sam_length[45]+=strlen(s);}
 else if (beginPos >= 48801708 && beginPos < 73202562) 
 {sam_length[46]+=strlen(s);}
 else if (beginPos >= 73202562 && beginPos < 97603416) 
 {sam_length[47]+=strlen(s);}
 else if (beginPos >= 97603416 && beginPos < 122004270) 
 {sam_length[48]+=strlen(s);}
 else if (beginPos >= 122004270 && beginPos < 146405124) 
 {sam_length[49]+=strlen(s);}
 else {sam_length[50]+=strlen(s);}
}
else if  (strcmp(refID, "chr7")==0) 
{
if (beginPos < 22763710 )  
 {sam_length[51]+=strlen(s);}
 else if (beginPos >= 22763710 && beginPos < 45527420) 
 {sam_length[52]+=strlen(s);}
 else if (beginPos >= 45527420 && beginPos < 68291130) 
 {sam_length[53]+=strlen(s);}
 else if (beginPos >= 68291130 && beginPos < 91054840) 
 {sam_length[54]+=strlen(s);}
 else if (beginPos >= 91054840 && beginPos < 113818550) 
 {sam_length[55]+=strlen(s);}
 else if (beginPos >= 113818550 && beginPos < 136582260) 
 {sam_length[56]+=strlen(s);}
 else {sam_length[57]+=strlen(s);}
}
else if (strcmp(refID, "chr8")==0)
{
if (beginPos < 24189772 )  
 {sam_length[58]+=strlen(s);}
 else if (beginPos >= 24189772 && beginPos < 48379544) 
 {sam_length[59]+=strlen(s);}
 else if (beginPos >= 48379544 && beginPos < 72569316) 
 {sam_length[60]+=strlen(s);}
 else if (beginPos >= 72569316 && beginPos < 96759088) 
 {sam_length[61]+=strlen(s);}
 else if (beginPos >= 96759088 && beginPos < 120948860) 
 {sam_length[62]+=strlen(s);}
 else {sam_length[63]+=strlen(s);}
}
else if  (strcmp(refID, "chr9")==0)
{
if (beginPos < 23065786 )  
 {sam_length[64]+=strlen(s);}
 else if (beginPos >= 23065786 && beginPos < 46131572) 
 {sam_length[65]+=strlen(s);}
 else if (beginPos >= 46131572 && beginPos < 69197358) 
 {sam_length[66]+=strlen(s);}
 else if (beginPos >= 69197358 && beginPos < 92263144) 
 {sam_length[67]+=strlen(s);}
 else if (beginPos >= 92263144 && beginPos < 115328930) 
 {sam_length[68]+=strlen(s);}
 else {sam_length[69]+=strlen(s);}
}
else if (strcmp(refID, "chr10")==0) 
{
if (beginPos < 22299570 )  
 {sam_length[70]+=strlen(s);}
 else if (beginPos >= 22299570 && beginPos < 44599140) 
 {sam_length[71]+=strlen(s);}
 else if (beginPos >= 44599140 && beginPos < 66898710) 
 {sam_length[72]+=strlen(s);}
 else if (beginPos >= 66898710 && beginPos < 89198280) 
 {sam_length[73]+=strlen(s);}
 else if (beginPos >= 89198280 && beginPos < 111497850) 
 {sam_length[74]+=strlen(s);}
 else {sam_length[75]+=strlen(s);}
}
else if  (strcmp(refID, "chr11")==0) 
{
if (beginPos < 22514437 )  
 {sam_length[76]+=strlen(s);}
 else if (beginPos >= 22514437 && beginPos < 45028874) 
 {sam_length[77]+=strlen(s);}
 else if (beginPos >= 45028874 && beginPos < 67543311) 
 {sam_length[78]+=strlen(s);}
 else if (beginPos >= 67543311 && beginPos < 90057748) 
 {sam_length[79]+=strlen(s);}
 else if (beginPos >= 90057748 && beginPos < 112572185) 
 {sam_length[80]+=strlen(s);}
 else {sam_length[81]+=strlen(s);}
}
else if (strcmp(refID, "chr12")==0) 
{
 if (beginPos < 22299570 )  
 {sam_length[82]+=strlen(s);}
 else if (beginPos >= 22299570 && beginPos < 44599140) 
 {sam_length[83]+=strlen(s);}
 else if (beginPos >= 44599140 && beginPos < 66898710) 
 {sam_length[84]+=strlen(s);}
 else if (beginPos >= 66898710 && beginPos < 89198280) 
 {sam_length[85]+=strlen(s);}
 else if (beginPos >= 89198280 && beginPos < 111497850) 
 {sam_length[86]+=strlen(s);}
 else {sam_length[87]+=strlen(s);}
}
else if (strcmp(refID, "chr13")==0) 
{
 if (beginPos < 22872865 )  
 {sam_length[88]+=strlen(s);}
 else if (beginPos >= 22872865 && beginPos < 45745730) 
 {sam_length[89]+=strlen(s);}
 else if (beginPos >= 45745730 && beginPos < 68618595) 
 {sam_length[90]+=strlen(s);}
 else if (beginPos >= 68618595 && beginPos < 91491460) 
 {sam_length[91]+=strlen(s);}
 else {sam_length[92]+=strlen(s);}
}
else if (strcmp(refID, "chr14")==0) 
{
 if (beginPos < 26760929)  
 {sam_length[93]+=strlen(s);}
 else if (beginPos >= 26760929 && beginPos < 53521858) 
 {sam_length[94]+=strlen(s);}
 else if (beginPos >= 53521858 && beginPos < 80282787) 
 {sam_length[95]+=strlen(s);}
 else {sam_length[96]+=strlen(s);}
}
else if (strcmp(refID, "chr15")==0) 
{
 if (beginPos < 25497797 )  
 {sam_length[97]+=strlen(s);}
 else if (beginPos >= 25497797 && beginPos < 50995594) 
 {sam_length[98]+=strlen(s);}
 else if (beginPos >= 50995594 && beginPos < 76493391) 
 {sam_length[99]+=strlen(s);}
 else {sam_length[100]+=strlen(s);}
}
else if (strcmp(refID, "chr16")==0) 
{
 if (beginPos < 22584586 )  
 {sam_length[101]+=strlen(s);}
 else if (beginPos >= 22584586 && beginPos < 45169172) 
 {sam_length[102]+=strlen(s);}
 else if (beginPos >= 45169172 && beginPos < 67753758) 
 {sam_length[103]+=strlen(s);}
 else {sam_length[104]+=strlen(s);}
}
else if (strcmp(refID, "chr17")==0) 
{
 if (beginPos < 27752480 )  
 {sam_length[105]+=strlen(s);}
 else if (beginPos >= 27752480 && beginPos < 55504960) 
 {sam_length[106]+=strlen(s);}
 else {sam_length[107]+=strlen(s);}
}
else if (strcmp(refID, "chr18")==0) 
{
 if (beginPos < 26791095 )  
 {sam_length[108]+=strlen(s);}
 else if (beginPos >= 26791095 && beginPos < 53582190) 
 {sam_length[109]+=strlen(s);}
 else {sam_length[110]+=strlen(s);}
}
else if (strcmp(refID, "chr19")==0) 
{
 if (beginPos < 29308808 )  
 {sam_length[111]+=strlen(s);}
 else {sam_length[112]+=strlen(s);}
}
else if (strcmp(refID, "chr20")==0) 
{
 if (beginPos < 21481389 )  
 {sam_length[113]+=strlen(s);}
 else if (beginPos >= 21481389 && beginPos < 42962778) 
 {sam_length[114]+=strlen(s);}
 else {sam_length[115]+=strlen(s);}
}
else if (strcmp(refID, "chr21")==0) 
{
 if (beginPos < 23354991 )  
 {sam_length[116]+=strlen(s);}
 else {sam_length[117]+=strlen(s);}
}
else if (strcmp(refID, "chr22")==0) 
{
 if (beginPos < 25409234 )  
 {sam_length[118]+=strlen(s);}
 else {sam_length[119]+=strlen(s);}
}
else if (strcmp(refID, "chrX")==0) 
{
 if (beginPos < 26006815 )  
 {sam_length[120]+=strlen(s);}
 else if (beginPos >= 26006815 && beginPos < 52013630) 
 {sam_length[121]+=strlen(s);}
 else if (beginPos >= 52013630 && beginPos < 78020445) 
 {sam_length[122]+=strlen(s);}
 else if (beginPos >= 78020445 && beginPos < 104027260) 
 {sam_length[123]+=strlen(s);}
 else if (beginPos >= 104027260 && beginPos < 130034075) 
 {sam_length[124]+=strlen(s);}
 else{sam_length[125]+=strlen(s);}
}
else if (strcmp(refID, "chrY")==0) 
{
 if (beginPos < 28613707 )  
 {sam_length[126]+=strlen(s);}
 else {sam_length[127]+=strlen(s);}
}
else if (strcmp(refID, "chrM")==0) 
{
 {sam_length[128]+=strlen(s);}
}
}
void mem_aln2sam(const mem_opt_t *opt, const bntseq_t *bns, kstring_t *str, bseq1_t *s, int n, const mem_aln_t *list, int which, const mem_aln_t *m_)
{
	...
	if (m && m->rid >= 0) {
		if (p->rid == m->rid) {kputc('=', str);
                                       s->rNext=malloc(2);
                                       s->rNext[0] = '=';s->rNext[1] = '\0';}
		else {kputs(bns->anns[m->rid].name, str);
                      s->rNext = malloc(strlen(bns->anns[m->rid].name)+1);
		      strcpy(s->rNext, bns->anns[m->rid].name);}
		kputc('\t', str);
	...
	kputc('\n', str);
        //str_len2count(s->beginPos, s->refID, str->s);   
}
